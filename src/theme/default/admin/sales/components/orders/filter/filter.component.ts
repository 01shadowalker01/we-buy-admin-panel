...
export class OrderFilterComponent implements OnInit {
    ...
    constructor(public fb: FormBuilder, public appSandbox: OrdersSandbox, public orderStatusSandbox: OrderstatusSandbox) {
    ...
    initForm() {
        ...
        this.orderStatusId = new FormControl(''),
            this.salesOrder = this.fb.group({
                ...
                orderId: this.orderId, status: this.status, total: this.total, orderStatusId: this.orderStatusId
            });
